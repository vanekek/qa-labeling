...
def _trim_input(tokenizer, config, title, question, answer, max_sequence_length=290, t_max_len=30, q_max_len=128, a_max_len=128):
...
def compute_input_arays(df, columns, tokenizer, config, max_sequence_length,t_max_len=30, q_max_len=128, a_max_len=128):
    
    input_ids, input_masks, input_segments = [], [], []
    for _, instance in df[columns].iterrows():
        t, q, a = instance.question_title, instance.question_body, instance.answer
        t, q, a = _trim_input(tokenizer, config, t, q, a, max_sequence_length,t_max_len, q_max_len, a_max_len)
